...
// Imprimindo o primeiro atributo escolhido e os respectivos valores para cada carta
...
if (atributo1 == 1) {
        ...
        printf("ÁREA\n"); 
        printf("Carta 1 (%s) - Área: %.3f km²\n", cidade_C1, area_C1);
        printf("Carta 2 (%s) - Área: %.3f km²\n", cidade_C2, area_C2);
        printf("--------------------------------------------------------------\n");
    } else if (atributo1 == 3) {
        printf("PIB\n"); 
        printf("Carta 1 (%s) - PIB: %.1f bilhões de reais\n", cidade_C1, pib_C1 / 1000000000); // Ajuste saída para aparecer 'bilhões de reais'.
        printf("Carta 2 (%s) - PIB: %.1f bilhões de reais\n", cidade_C2, pib_C2/ 1000000000); // Ajuste saída para aparecer 'bilhões de reais'.
        printf("--------------------------------------------------------------\n");
    } else if (atributo1 == 4) {
...
// Imprimindo o segundo atributo escolhido e os respectivos valores para cada carta 
